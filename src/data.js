...
export const projects = [
...

  {
    ...
    groups: ["Agentic AI"],
    description:
      "An agentic interview simulator that decides what to ask you next based on how you just answered, then grades every claim against your own words. The model does one job per turn - it reads your answer and scores how complete it was, with a quote as proof - and plain code makes every decision after that: probe deeper, switch competency, or stop. A fixed 12-question budget reaches every skill once before it goes by weight × uncertainty, because the first version, ranking by weight × uncertainty alone, spent all 12 questions on 3 of 5 skills. Three interviewer personas change how hard you're pushed but never how you're graded. An evidence gate checks every score's quote word for word against your transcript; a score it can't find is regenerated once, then shown flagged as low confidence instead of being trusted.",
    tags: ["Agentic AI", "NVIDIA NIM", "Voice AI", "FastAPI", "Python"],
    metric: "ρ 0.90 ranking · 2 runs",
    ...
    demoLabel: "case study",
    highlights: [
      "Agent, not pipeline: the model only scores each answer, and plain code decides whether to probe, which competency to ask next and when to stop - the budget covers every skill once, then spends the rest by weight × uncertainty",
      "Evidence gate: every score must quote your transcript word for word; a score whose quote can't be found is regenerated once, then shown flagged as low confidence rather than trusted",
      "Re-evaluated on Nemotron 3 Super after NVIDIA retired Llama 3.1 8B: ρ 0.90 ranking agreement with a person in both runs, a regrade spread of 0.32 / 0.33 out of 10, and 4 of 4 vague answers followed up - but answers I rated 3 to 6 out of 10 were scored 2 or 3, and the test sets are small (10 answers, and 4 for follow-ups)",
    ],
  },
  {
